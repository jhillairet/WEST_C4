...
nco = 1e19
Rant = IC_Positions[2]
idx_nco = argmin(abs(data['NEX'] - 1e19), axis=0)
...
#ax[2].plot(t_Rc_Q4, Rc_Q4, lw=2, label='Rc Q4')
ax[2].plot(t_Rc_Q4_left, Rc_Q4_left, label='Rc Q4 left')
ax[2].plot(t_Rc_Q4_right, Rc_Q4_right, label='Rc Q4 right')
