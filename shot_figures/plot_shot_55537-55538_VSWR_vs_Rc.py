...
#%%%
VSWR_Q1_left, t_VSWR_Q1_left = get_sig(pulse, signals['IC_VSWR_Q1_Left'])
VSWR_Q1_right, t_VSWR_Q1_right = get_sig(pulse, signals['IC_VSWR_Q1_Right'])
...
#%%
_Rc_Q1_left = np.interp(t_VSWR_Q1_left[:,0], t_Rc_Q1_left, Rc_Q1_left)
_Rc_Q1_right = np.interp(t_VSWR_Q1_right[:,0], t_Rc_Q1_right, Rc_Q1_right)

#%%
fig, ax = plt.subplots()
ax.plot(_Rc_Q1_left, VSWR_Q1_left, '.', label='left')
ax.plot(_Rc_Q1_right, VSWR_Q1_right, '.', label='Right')
...
#%%
_Rc_Q4_left = np.interp(t_VSWR_Q4_left[:,0], t_Rc_Q4_left, Rc_Q4_left)
_Rc_Q4_right = np.interp(t_VSWR_Q4_right[:,0], t_Rc_Q4_right, Rc_Q4_right)

#%%
fig, ax = plt.subplots()
ax.plot(_Rc_Q4_left, VSWR_Q4_left, '.', label='left')
ax.plot(_Rc_Q4_right, VSWR_Q4_right, '.', label='Right')
ax.set_ylim(bottom=1, top=4)
ax.set_xlim(left=0, right=2)
