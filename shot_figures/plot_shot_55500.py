...
# ax[1].plot(t_LH_tot, P_LH_tot*1e3, label='LH', lw=2, color='C0')
# ax[1].plot(t_Q1, P_Q1, label='IC Q1', lw=2, color='C1')
ax[1].plot(t_Q2, P_Q2, label='IC Q2', lw=2, color='C2')
ax[1].plot(t_Q4, P_Q4, label='IC Q4', lw=2, color='C3')
...
ax[2].plot(trad, Prad*1e3, lw=2)
ax[2].set_ylim(0, 1000)
ax[2].set_ylabel('Radiated Power [kW]', fontsize=14)

ax3 = ax[2].twinx()
ax3.plot(t_Te, Te, lw=2, color='C1')
ax3.set_ylabel('Te [eV]', fontsize=14, color='C1')
